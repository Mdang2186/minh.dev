...
function ResumeModal({ resumeUrl }) {
    ...
    const [numPages, setNumPages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ResumeModal.useEffect": ()=>{
            const updateScale = {
                "ResumeModal.useEffect.updateScale": ()=>{
            ...
            return ({
                "ResumeModal.useEffect": ()=>window.removeEventListener("resize", updateScale)
            })["ResumeModal.useEffect"];
        }
    }["ResumeModal.useEffect"], [
        isOpen
        ...
        "ResumeModal.useEffect": ()=>{
            const handleKeyDown = {
                "ResumeModal.useEffect.handleKeyDown": (e)=>{
                    ...
                    if (e.key === "ArrowRight" && numPages && pageNumber < numPages) setPageNumber({
                        "ResumeModal.useEffect.handleKeyDown": (prev)=>prev + 1
                    }["ResumeModal.useEffect.handleKeyDown"]);
                    if (e.key === "ArrowLeft" && pageNumber > 1) setPageNumber({
                        "ResumeModal.useEffect.handleKeyDown": (prev)=>prev - 1
                    }["ResumeModal.useEffect.handleKeyDown"]);
                }
            }["ResumeModal.useEffect.handleKeyDown"];
...
_s(ResumeModal, "ugxeS6JomuAEOOIwuE15eT7Uje4=");
_c = ResumeModal;
var _c;
