    ...
    return (
        <section className="py-8 md:py-12 relative w-full flex justify-center items-center px-6">
            <div className="relative z-10 max-w-5xl mx-auto text-center flex flex-col items-center">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[46px] font-medium text-slate-400 dark:text-slate-500 leading-[1.4] tracking-tight">
                    ...
                    <span className="inline-block px-4 py-1.5 md:px-6 md:py-2 mt-3 md:mt-0 bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-500 text-white font-extrabold rounded-xl transform md:-rotate-2 text-xl sm:text-2xl md:text-3xl">
                        {t("line3_2")}
                    </span>
                </h2>
