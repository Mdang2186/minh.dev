        ...
        <section className="py-8 md:py-10 flex justify-center items-center px-0 md:px-4 relative w-[100vw] left-[50%] right-[50%] -ml-[50vw] -mr-[50vw] bg-white overflow-hidden">
            ...
            <div className="flex flex-col items-center md:items-start relative z-10 bg-white px-4 md:px-24 py-4">
                ...
                <div className="flex flex-row md:items-baseline items-center gap-2 md:gap-8 justify-center md:justify-start flex-nowrap whitespace-nowrap pr-8 md:pr-40">
                    ...
                    <span className="text-base sm:text-lg md:text-[30px] text-[#334054] italic font-light pb-0 md:pb-4 tracking-wide">
                        {t("line1_2")}
                    </span>
                </div>
                ...
                <div className="flex flex-row items-baseline justify-center md:justify-start gap-1 md:gap-3 mt-2 md:mt-2 md:pl-[380px] flex-nowrap whitespace-nowrap">
                    <span className="text-base sm:text-lg md:text-[28px] font-light text-[#334054] tracking-wide">{t("line2_1")}</span>
                    <span className="text-xl sm:text-2xl md:text-[48px] font-extrabold text-[#334054] tracking-normal">
                        {t("line2_2")} 
                    </span>
                    <span className="text-base sm:text-lg md:text-[28px] font-light italic text-[#334054] tracking-wide px-1 md:px-2">{t("line2_3")}</span> 
                    <span className="text-xl sm:text-2xl md:text-[48px] font-extrabold text-[#334054] tracking-normal">
                        {t("line2_4")}
                    </span>
                </div>
                ...
                <div className="flex flex-row items-center justify-center md:justify-start gap-2 md:gap-6 mt-4 md:mt-6 md:pl-[140px] flex-nowrap whitespace-nowrap">
                    <div className="flex flex-row items-center justify-center gap-2 md:gap-4 flex-nowrap whitespace-nowrap">
                        <span className="text-2xl sm:text-3xl md:text-[48px] font-light text-[#334054] tracking-wide pr-1 md:pr-2">
                            {t("line1_1")}
                        </span>
                        <span className="text-2xl sm:text-3xl md:text-[48px] font-light text-[#334054] tracking-wide pr-2 md:pr-4">
                            {t("line3_1")}
                        </span>
                        <span className="text-xl sm:text-2xl md:text-[48px] italic font-extrabold text-[#334054] bg-[#eef2f6] px-5 md:px-14 py-2 md:py-4 rounded-full md:rounded-[1.5rem] tracking-normal">
                            {t("line3_2")}
                        </span>
                    </div>
                </div>
