...
export default function CreateTimelineNodePage() {
  return (
    <div className="mx-auto max-w-4xl space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-black tracking-tight text-slate-900">Thêm Timeline Node</h1>
          <p className="mt-1 text-sm text-slate-500">Tạo mốc thời gian mới cho My Journey.</p>
        </div>
      </div>
